...
import logo from '../img/logo/chico/logo-chico.png';
...
const Navigation = ({history}) => {
  ...
  return(
    <div className = 'fixed top-0 w-screen'>
      <nav className="flex justify-between items-center h-16 bg-fisio text-white relative shadow-sm font-sans" role='navigation'>
        ...
        <div className="pr-8 md:block hidden">
          ...
          <Link
            ...
            duration={500}
          >Contacto</Link>
          {/* <Link className="nav-btn" to = '/nosotros'>Nosotros</Link> */}
          {/* <Link className="nav-btn" to = '/servicios'>Servicios</Link> */}
          {/* <Link className="nav-btn" to = '/contacto'>Contacto</Link> */}
